...
export default {
  ...
  translation: {
    common: {
      ...
      canCreatePersonalProjectsOnly: 'Kan bara skapa personliga projekt.',
      personalProjectOwner: 'Personlig projektägare',
      personalProjectsLimitReached: 'Gränsen för personliga projekt har uppnåtts.',
