...
export default {
  ...
  translation: {
    common: {
      ...
      canCreatePersonalProjectsOnly: 'فقط می‌تواند پروژه‌های شخصی ایجاد کند.',
      ...
      personalProjectOwner: 'صاحب پروژه شخصی',
      personalProjectsLimitReached: 'حد پروژه‌های شخصی پر شده است.',
