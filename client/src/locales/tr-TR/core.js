...
export default {
  ...
  translation: {
    common: {
      ...
      canCreatePersonalProjectsOnly: 'Yalnızca kişisel projeler oluşturabilir.',
      personalProjectOwner: 'Kişisel proje sahibi',
      personalProjectsLimitReached: 'Kişisel projeler sınırına ulaşıldı.',
