...
export default {
  ...
  translation: {
    common: {
      ...
      canCreatePersonalProjectsOnly: 'Može da kreira samo lične projekte.',
      ...
      personalProjectOwner: 'Vlasnik ličnog projekta',
      personalProjectsLimitReached: 'Dostignut je limit ličnih projekata.',
