...
export default {
  ...
  translation: {
    common: {
      ...
      addEpic_title: 'Ajouter une épique',
      editEpic_title: "Modifier l'épique",
      ...
      createEpic_title: 'Créer une épique',
