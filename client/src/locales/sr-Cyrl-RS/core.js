...
export default {
  ...
  translation: {
    common: {
      ...
      canCreatePersonalProjectsOnly: 'Може да креира само личне пројекте.',
      ...
      personalProjectOwner: 'Власник личног пројекта',
      personalProjectsLimitReached: 'Достигнут је лимит личних пројеката.',
