...
export default {
  ...
  translation: {
    common: {
      ...
      canCreatePersonalProjectsOnly: 'Faqat shaxsiy loyihalarni yaratishi mumkin.',
      personalProjectOwner: 'Shaxsiy loyiha egasi',
      personalProjectsLimitReached: 'Shaxsiy loyihalar chegarasiga yetildi.',
