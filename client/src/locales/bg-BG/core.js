...
export default {
  ...
  translation: {
    common: {
      ...
      canCreatePersonalProjectsOnly: 'Може да създава само лични проекти.',
      ...
      personalProjectOwner: 'Собственик на личен проект',
      personalProjectsLimitReached: 'Лимитът за лични проекти е достигнат.',
