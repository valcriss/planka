...
export default {
  ...
  translation: {
    common: {
      ...
      canCreatePersonalProjectsOnly: 'Só pode criar projetos pessoais.',
      ...
      personalProjectOwner: 'Proprietário de projeto pessoal',
      personalProjectsLimitReached: 'O limite de projetos pessoais foi alcançado.',
