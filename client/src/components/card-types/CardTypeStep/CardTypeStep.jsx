...
import styles from './CardTypeStep.module.scss';
...
const CardTypeStep = React.memo(({ id, onBack, onClose }) => {
  ...
  const defaultData = useMemo(
    () => ({
      ...
      hasStopwatch: cardType.hasStopwatch,
      hasTaskList: cardType.hasTaskList,
      canLinkCards: cardType.canLinkCards,
    }),
    [cardType],
  );
  ...
  const handleSubmit = useCallback(() => {
    ...
    if (!dequal(cleanData, defaultData)) {
      dispatch(entryActions.updateCardType(id, cleanData));
    }
