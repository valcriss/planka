...
export default {
  ...
  /* Base card types */
  BASE_CARD_TYPE_CREATE: 'BASE_CARD_TYPE_CREATE',
  BASE_CARD_TYPE_CREATE__SUCCESS: 'BASE_CARD_TYPE_CREATE__SUCCESS',
  BASE_CARD_TYPE_CREATE__FAILURE: 'BASE_CARD_TYPE_CREATE__FAILURE',
  BASE_CARD_TYPE_CREATE_HANDLE: 'BASE_CARD_TYPE_CREATE_HANDLE',
  BASE_CARD_TYPE_UPDATE: 'BASE_CARD_TYPE_UPDATE',
  BASE_CARD_TYPE_UPDATE__SUCCESS: 'BASE_CARD_TYPE_UPDATE__SUCCESS',
  BASE_CARD_TYPE_UPDATE__FAILURE: 'BASE_CARD_TYPE_UPDATE__FAILURE',
  BASE_CARD_TYPE_UPDATE_HANDLE: 'BASE_CARD_TYPE_UPDATE_HANDLE',
  BASE_CARD_TYPE_DELETE: 'BASE_CARD_TYPE_DELETE',
  BASE_CARD_TYPE_DELETE__SUCCESS: 'BASE_CARD_TYPE_DELETE__SUCCESS',
  BASE_CARD_TYPE_DELETE__FAILURE: 'BASE_CARD_TYPE_DELETE__FAILURE',
  BASE_CARD_TYPE_DELETE_HANDLE: 'BASE_CARD_TYPE_DELETE_HANDLE',
  BASE_CARD_TYPES_FETCH: 'BASE_CARD_TYPES_FETCH',
  BASE_CARD_TYPES_FETCH__SUCCESS: 'BASE_CARD_TYPES_FETCH__SUCCESS',
  BASE_CARD_TYPES_FETCH__FAILURE: 'BASE_CARD_TYPES_FETCH__FAILURE',

  /* Card types */
  CARD_TYPE_CREATE: 'CARD_TYPE_CREATE',
  CARD_TYPE_CREATE__SUCCESS: 'CARD_TYPE_CREATE__SUCCESS',
  CARD_TYPE_CREATE__FAILURE: 'CARD_TYPE_CREATE__FAILURE',
  CARD_TYPE_CREATE_HANDLE: 'CARD_TYPE_CREATE_HANDLE',
  CARD_TYPE_UPDATE: 'CARD_TYPE_UPDATE',
  CARD_TYPE_UPDATE__SUCCESS: 'CARD_TYPE_UPDATE__SUCCESS',
  CARD_TYPE_UPDATE__FAILURE: 'CARD_TYPE_UPDATE__FAILURE',
  CARD_TYPE_UPDATE_HANDLE: 'CARD_TYPE_UPDATE_HANDLE',
  CARD_TYPE_DELETE: 'CARD_TYPE_DELETE',
  CARD_TYPE_DELETE__SUCCESS: 'CARD_TYPE_DELETE__SUCCESS',
  CARD_TYPE_DELETE__FAILURE: 'CARD_TYPE_DELETE__FAILURE',
  CARD_TYPE_DELETE_HANDLE: 'CARD_TYPE_DELETE_HANDLE',
  CARD_TYPES_FETCH: 'CARD_TYPES_FETCH',
  CARD_TYPES_FETCH__SUCCESS: 'CARD_TYPES_FETCH__SUCCESS',
  CARD_TYPES_FETCH__FAILURE: 'CARD_TYPES_FETCH__FAILURE',
  ...
  EPIC_CREATE__SUCCESS: 'EPIC_CREATE__SUCCESS',
  EPIC_CREATE__FAILURE: 'EPIC_CREATE__FAILURE',
  EPIC_UPDATE: 'EPIC_UPDATE',
  EPIC_UPDATE__SUCCESS: 'EPIC_UPDATE__SUCCESS',
  EPIC_UPDATE__FAILURE: 'EPIC_UPDATE__FAILURE',
  EPIC_DELETE: 'EPIC_DELETE',
  EPIC_DELETE__SUCCESS: 'EPIC_DELETE__SUCCESS',
  EPIC_DELETE__FAILURE: 'EPIC_DELETE__FAILURE',
  EPICS_FETCH: 'EPICS_FETCH',
  EPICS_FETCH__SUCCESS: 'EPICS_FETCH__SUCCESS',
  EPICS_FETCH__FAILURE: 'EPICS_FETCH__FAILURE',
  ...
  CARD_LINKS_SEARCH: 'CARD_LINKS_SEARCH',
  CARD_LINKS_SEARCH__SUCCESS: 'CARD_LINKS_SEARCH__SUCCESS',
  CARD_LINKS_SEARCH__FAILURE: 'CARD_LINKS_SEARCH__FAILURE',
