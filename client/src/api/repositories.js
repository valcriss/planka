...
const updateRepository = (id, data, headers) =>
  socket.patch(`/repositories/${id}`, data, headers);

const deleteRepository = (id, headers) =>
  socket.delete(`/repositories/${id}`, undefined, headers);
