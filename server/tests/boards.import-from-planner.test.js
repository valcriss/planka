...
describe('boards/import-from-planner helper', () => {
  ...
  test('creates lists, labels, cards, memberships and tasks from planner rows', async () => {
    ...
    const planner = {
      ...
      sheetName: 'Plan',
      columns: [
        { key: 'taskId', original: 'ID de tâche', index: 0 },
        { key: 'taskName', original: 'Nom de tâche', index: 1 },
        { key: 'bucketName', original: 'Nom du compartiment', index: 2 },
        { key: 'progress', original: 'Progression', index: 3 },
        { key: 'priority', original: 'Priorité', index: 4 },
        { key: 'assignments', original: 'Attribué à', index: 5 },
        { key: 'createdBy', original: 'Créé par', index: 6 },
        { key: 'createdDate', original: 'Date de création', index: 7 },
        { key: 'startDate', original: 'Date de début', index: 8 },
        { key: 'dueDate', original: "Date d'échéance", index: 9 },
        { key: 'estPeriodique', original: 'Est périodique', index: 10 },
        { key: 'enRetard', original: 'En retard', index: 11 },
        { key: 'completedDate', original: 'Date de fin', index: 12 },
        { key: 'executedBy', original: 'Exécuté par', index: 13 },
        {
          key: 'elementsDeLaListeDeControleEffectues',
          original: 'Éléments de la liste de contrôle effectués',
          index: 14,
        },
        {
          key: 'checklistItems',
          original: 'Éléments de la liste de contrôle',
          index: 15,
        },
        { key: 'labels', original: 'Étiquettes', index: 16 },
        { key: 'description', original: 'Description', index: 17 },
      ],
      rows: [
        {
          taskId: 'task-1',
        ...
        },
        {
          ...
          enRetard: null,
          checklistItems: null,
          elementsDeLaListeDeControleEffectues: null,
          plannerColumnValues: [
            'task-2',
            'Clôturer projet',
            'Terminé',
